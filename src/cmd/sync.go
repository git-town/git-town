...
func syncBranchesSteps(config *syncConfig) (steps.StepList, error) {
...
func syncBranchSteps(list *steps.StepListBuilder, args syncBranchStepsArgs) {
...
func syncFeatureBranchSteps(list *steps.StepListBuilder, branch domain.BranchInfo, lineage config.Lineage, syncStrategy config.SyncStrategy) {
...
func syncPerennialBranchSteps(list *steps.StepListBuilder, args syncPerennialBranchStepsArgs) {
...
func pullTrackingBranchOfCurrentFeatureBranchStep(list *steps.StepListBuilder, trackingBranch domain.RemoteBranchName, strategy config.SyncStrategy) {
	switch strategy {
...
func pullParentBranchOfCurrentFeatureBranchStep(list *steps.StepListBuilder, parentBranch domain.LocalBranchName, strategy config.SyncStrategy) {
	switch strategy {
	case config.SyncStrategyMerge:
...
func updateCurrentPerennialBranchStep(list *steps.StepListBuilder, otherBranch domain.RemoteBranchName, strategy config.PullBranchStrategy) {
	switch strategy {
...
func pushFeatureBranchSteps(list *steps.StepListBuilder, branch domain.LocalBranchName, syncStrategy config.SyncStrategy, pushHook bool) {
	switch syncStrategy {
	case config.SyncStrategyMerge:
