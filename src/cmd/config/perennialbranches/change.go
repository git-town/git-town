...
func executeUpdate(verbose bool) error {
	...
	newPerennialBranches, aborted, err := enter.PerennialBranches(branchesSnapshot.Branches.Names(), repo.Runner.PerennialBranches, repo.Runner.MainBranch, dialogTestInputs.Next())
	if err != nil || aborted {
		return err
	}
