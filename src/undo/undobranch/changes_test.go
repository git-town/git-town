...
func TestChanges(t *testing.T) {
	...
	t.Run("local-only branch added", func(t *testing.T) {
		...
		haveSpan := undobranch.NewSpans(before, after)
		wantSpan := undobranch.Spans{
			undobranch.Span{
		...
		wantChanges := undobranch.Changes{
		...
		haveProgram := haveChanges.UndoProgram(undobranch.ChangesUndoProgramArgs{
			Lineage:                  lineage,
	...
	t.Run("local-only branch removed", func(t *testing.T) {
		...
		span := undobranch.NewSpans(before, after)
