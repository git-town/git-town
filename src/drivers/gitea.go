...
// giteaConfigurationInterface defines the gitea's interface to configuration.
type giteaConfigurationInterface interface {
...
// GitConfig implements giteaConfigurationInterface.
var _ giteaConfigurationInterface = (*GitConfig)(nil)
