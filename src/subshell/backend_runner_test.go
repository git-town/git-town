...
func TestBackendRunner(t *testing.T) {
	...
	t.Run("Query", func(t *testing.T) {
		...
		t.Run("happy path", func(t *testing.T) {
			tmpDir := t.TempDir()
			runner := subshell.BackendRunner{Dir: &tmpDir, Verbose: false, CommandsCounter: nil}
...
----------------------------------------`
	...
	t.Run("QueryTrim", func(t *testing.T) {
		...
		t.Run("trims whitespace", func(t *testing.T) {
			tmpDir := t.TempDir()
			runner := subshell.BackendRunner{Dir: &tmpDir, Verbose: false, CommandsCounter: &runstate.CommandsCounter{}}
