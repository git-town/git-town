...
func syncDeletedBranchProgram(list *program.Program, branch syncdomain.BranchInfo, parentOtherWorktree bool, args SyncBranchProgramArgs) {
...
func syncDeletedFeatureBranchProgram(list *program.Program, branch syncdomain.BranchInfo, parentOtherWorktree bool, args SyncBranchProgramArgs) {
...
func syncDeletedPerennialBranchProgram(list *program.Program, branch syncdomain.BranchInfo, args SyncBranchProgramArgs) {
