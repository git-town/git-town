...
const (
	...
	HostingGitlabUpdateBaseBranchViaAPI = "GitLab API: Updating target branch for MR !%d to %q\n"
	...
	HostingGiteaUpdateBasebranchViaAPI  = "Gitea API: Updating base branch for PR #%d to #%s"
	HostingGithubMergingViaAPI          = "GitHub API: merging PR #%d\n"
	HostingGithubUpdateBasebranchViaAPI = "GitHub API: updating base branch for PR #%d\n"
	...
	RunProblem                          = "error running command %q: %w"
