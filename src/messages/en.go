...
`
	...
	PrototypeBranchIsAlreadyPrototype       = "branch %q is already a prototype branch\n"
	PrototypeBranchIsNowPrototype           = "branch %q is now a prototype branch\n"
	PrototypeCannotPrototypeMainBranch      = "cannot make the main branch a prototype branch"
	PrototypeCannotPrototypePerennialBranch = "cannot make perennial branches a prototype branch"
