...
func TestBackendCommands(t *testing.T) {
	...
	t.Run("CommitsInBranch", func(t *testing.T) {
		...
		t.Run("feature branch contains commits", func(t *testing.T) {
			...
			commits := runtime.TestCommands.CommitsInBranch(runtime.TestCommands, branch, Some(gitdomain.NewLocalBranchName("initial")))
			must.NoError(t, err)
		...
		t.Run("feature branch contains no commits", func(t *testing.T) {
			...
			branch := gitdomain.NewLocalBranchName("branch1")
			runtime.CreateBranch(branch, initial)
			commits, err := runtime.TestCommands.CommitsInBranch(runtime.TestCommands, branch, Some(gitdomain.NewLocalBranchName("initial")))
			must.NoError(t, err)
		...
		t.Run("main branch contains commits", func(t *testing.T) {
			...
			commits := runtime.TestCommands.CommitsInBranch(runtime.TestCommands, initial, None[gitdomain.LocalBranchName]())
			must.NoError(t, err)
		...
		t.Run("main branch contains no commits", func(t *testing.T) {
			t.Parallel()
			runtime := testruntime.Create(t)
			commits, err := runtime.Git.CommitsInBranch(runtime.TestCommands, initial, None[gitdomain.LocalBranchName]())
			must.NoError(t, err)
	...
	t.Run("CurrentBranch", func(t *testing.T) {
		...
		branch, err := runtime.Git.CurrentBranch(runtime.TestCommands)
		must.NoError(t, err)
	...
	t.Run("DefaultBranch", func(t *testing.T) {
		...
		have := runtime.Git.DefaultBranch(runtime.TestCommands)
	...
	t.Run("FirstExistingBranch", func(t *testing.T) {
		...
		t.Run("first branch matches", func(t *testing.T) {
			...
			have := runtime.Git.FirstExistingBranch(runtime.TestCommands, branch1, branch2)
			want := Some(branch1)
			must.Eq(t, want, have)
		})
	...
	t.Run("HasLocalBranch", func(t *testing.T) {
		...
		must.True(t, runner.Git.HasLocalBranch(runner.TestCommands, gitdomain.NewLocalBranchName("b1")))
		must.True(t, runner.Git.HasLocalBranch(runner.TestCommands, gitdomain.NewLocalBranchName("b2")))
		must.False(t, runner.Git.HasLocalBranch(runner.TestCommands, gitdomain.NewLocalBranchName("b3")))
	})
	...
	t.Run("RepoStatus", func(t *testing.T) {
		t.Run("HasOpenChanges", func(t *testing.T) {
			...
			t.Run("no open changes", func(t *testing.T) {
				t.Parallel()
				runtime := testruntime.Create(t)
				have, err := runtime.Git.RepoStatus(runtime.TestCommands)
				must.NoError(t, err)
