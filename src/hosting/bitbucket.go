...
func (c *BitbucketConnector) FindProposal(_, target string) (*Proposal, error) {
...
func (c *BitbucketConnector) SquashMergeProposal(_ int, message string) (mergeSHA string, err error) {
