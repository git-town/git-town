...
func TestDetect(t *testing.T) {
	...
	tests := map[giturl.Parts]bool{
		asserts.FilterErr(giturl.Parse("git@gitlab.com:git-town/docs.git")):     true,  // SAAS URL
		asserts.FilterErr(giturl.Parse("git@custom-url.com:git-town/docs.git")): false, // custom URL
		asserts.FilterErr(giturl.Parse("git@github.com:git-town/git-town.git")): false, // other hosting URL
		emptyURL: false,
	}
