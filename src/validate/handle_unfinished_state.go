...
func HandleUnfinishedState(args UnfinishedStateArgs) (quit bool, err error) {
	...
	response, aborted, err := dialogs.AskHowToHandleUnfinishedRunState(
		runState.Command,
