...
const (
	...
	SyncStatusCheckedOutInAnotherWorkspace SyncStatus = "checked out in another worktree" // the branch is checked out in another worktree and should not be synced
)
