...
func (self *GitTown) Reload() {
	...
	self.Config = mergeAll(self.configFile, self.CachedAccess.FullCache)
}
...
func mergeAll(configFile configdomain.PartialConfig, fullCache gitconfig.FullCache) configdomain.Config {
