...
var (
	KeyAliasAppend                    = Key{"alias." + configdomain.AliasableCommandAppend.String()}       //nolint:gochecknoglobals
	KeyAliasDiffParent                = Key{"alias." + configdomain.AliasableCommandDiffParent.String()}   //nolint:gochecknoglobals
	KeyAliasHack                      = Key{"alias." + configdomain.AliasableCommandHack.String()}         //nolint:gochecknoglobals
	KeyAliasKill                      = Key{"alias." + configdomain.AliasableCommandKill.String()}         //nolint:gochecknoglobals
	KeyAliasPrepend                   = Key{"alias." + configdomain.AliasableCommandPrepend.String()}      //nolint:gochecknoglobals
	KeyAliasPropose                   = Key{"alias." + configdomain.AliasableCommandPropose.String()}      //nolint:gochecknoglobals
	KeyAliasRenameBranch              = Key{"alias." + configdomain.AliasableCommandRenameBranch.String()} //nolint:gochecknoglobals
	KeyAliasRepo                      = Key{"alias." + configdomain.AliasableCommandRepo.String()}         //nolint:gochecknoglobals
	KeyAliasShip                      = Key{"alias." + configdomain.AliasableCommandShip.String()}         //nolint:gochecknoglobals
	KeyAliasSync                      = Key{"alias." + configdomain.AliasableCommandSync.String()}         //nolint:gochecknoglobals
