...
func EnterParent(branch, defaultParent gitdomain.LocalBranchName, lineage configdomain.Lineage, branches undodomain.BranchInfos) (gitdomain.LocalBranchName, error) {
