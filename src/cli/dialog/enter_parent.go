...
func EnterParent(branch, defaultParent gitdomain.LocalBranchName, lineage configdomain.Lineage, branches domain.BranchInfos) (gitdomain.LocalBranchName, error) {
