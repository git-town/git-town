...
func TestCommitTableBuilder(t *testing.T) {
	...
	commit4 := git.Commit{SHA: domain.NewSHA("444444"), Branch: domain.NewLocalBranchName("branch2"), Message: "commit4"}
	commit5 := git.Commit{SHA: domain.NewSHA("555555"), Branch: domain.NewLocalBranchName("branch3"), Message: "commit5"}
