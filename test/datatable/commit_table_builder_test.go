...
func TestCommitTableBuilder(t *testing.T) {
	...
	commit1 := testgit.Commit{SHA: gitdomain.NewSHA("111111"), Branch: "branch1", Message: "commit1"}
	commit2 := testgit.Commit{SHA: gitdomain.NewSHA("222222"), Branch: "main", Message: "commit2"}
	commit3 := testgit.Commit{SHA: gitdomain.NewSHA("333333"), Branch: "main", Message: "commit3"}
	commit4 := testgit.Commit{SHA: gitdomain.NewSHA("444444"), Branch: "branch2", Message: "commit4"}
	commit5 := testgit.Commit{SHA: gitdomain.NewSHA("555555"), Branch: "branch3", Message: "commit5"}
