...
Big thanks to @Indemnity83, @OrHayat, @kevgo, @yaadata for contributing 15 shipped pull requests 3 resolved issues
...
- `git town switch` can now filter the branches to switch to via [regular expressions](https://www.git-town.com/commands/switch#positional-arguments) ([https://github.com/git-town/git-town/pull/3980/files](#3980))
