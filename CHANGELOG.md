...
- If a branch is listed as its own parent, Git Town now notifies the user and deletes this lineage entry ([#3393](https://github.com/git-town/git-town/pull/3393)).
