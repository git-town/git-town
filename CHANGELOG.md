...
- All visual dialogs now use a modern UI framework that fixes all rendering issues encountered before ([#2964](https://github.com/git-town/git-town/issues/2964)).
