...
- **Easier branch switching:** Running `git town switch --type=<branch types>` displays only branches of the given type ([#3933](https://github.com/git-town/git-town/issues/3933)).
