...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.git-town.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".git-town") // name of config file (without extension)
