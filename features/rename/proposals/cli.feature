Feature: rename the current feature branch and update proposals
  ...
  Scenario: result
    Then Git Town runs the commands
      ...
      |        | Finding proposal from gamma into new ... #3 (gamma proposal)  |
      |        | Update body for #1 ... ok                                     |
      |        | Finding all proposals for beta ... alpha                      |
      |        | Update body for #2 ... ok                                     |
      |        | Finding all proposals for gamma ... new                       |
      |        | Finding proposal from alpha into main ... #1 (alpha proposal) |
      |        | Finding proposal from new into alpha ... none                 |
    ...
    And the branches are now
      | REPOSITORY    | BRANCHES                |
      | local, origin | main, alpha, gamma, new |
