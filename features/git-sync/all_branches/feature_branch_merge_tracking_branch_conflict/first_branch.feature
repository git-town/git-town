Feature: git sync --all: handling merge conflicts between feature branch and its tracking branch
  ...
  Scenario: result
    ...
    And I get the error
      ...
      To skip the sync of the 'feature-1' branch, run "git sync --skip".
      """
