Feature: git sync: resolving conflicts between the current feature branch and the main branch

  Background:
    Given my repository has the "rebase" pull strategy configured
