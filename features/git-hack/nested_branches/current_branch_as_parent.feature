Feature: Creating nested feature branches
  ...
  Scenario: Creating a child branch of the current feature branch
    ...
    Then it runs the Git commands
      ...
      |               | git push                              |
      |               | git checkout -b child_feature feature |
      | child_feature | git stash pop                         |
    ...
    And I have the following commits
      ...
      | child_feature | local            | main_commit    | main_file    |
      | child_feature | local            | feature_commit | feature_file |
