Feature: git-hack allows moving existing open changes from the main branch into a new feature branch

  As a developer already working on a new feature while on the main branch
