...
Feature: ask for information not provided by the config file
  ...
  Scenario:
    ...
    When I run "git-town init" and enter into the dialogs:
      ...
      | proposal-breadcrumb-exclude-branches | down down down down space down down space enter |
      | interactive                          | enter                                           |
    ...
    Then Git Town runs the commands
      ...
      | git config git-town.proposal-breadcrumb-exclude-branches "contribution, prototype" |
