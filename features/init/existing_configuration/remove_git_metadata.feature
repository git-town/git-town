...
Feature: remove existing configuration in Git metadata
  ...
  Background:
    ...
    When I run "git-town init" and enter into the dialogs:
      ...
      | proposal-breadcrumb-exclude-branches | enter                                                                       |                     |
  ...
  Scenario: result
    Then Git Town runs the commands
      ...
      | git config git-town.proposal-breadcrumb-exclude-branches "" |
    ...
    And local Git setting "git-town.proposal-breadcrumb-exclude-branches" is now ""
