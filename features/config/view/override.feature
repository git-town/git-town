Feature: show the configuration
  ...
  Scenario:
    ...
    And Git setting "git-town.perennial-branches" is "local-perennial-1 local-perennial-2"
    And Git setting "git-town.auto-sync" is "false"
    And Git setting "git-town.branch-prefix" is ""
    And Git setting "git-town.contribution-regex" is ""
    And Git setting "git-town.detached" is ""
