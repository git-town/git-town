Feature: delete the current feature branch with a different tracking branch

  Background:
    Given the current branch is a feature branch "current" with tracking branch "origin/tracking"
