Feature: sync stacked changes and update proposals with forge references
  ...
  Scenario: GitHub references
    Given the origin is "git@github.com:git-town/git-town.git"
    And Git setting "git-town.forge-type" is "github"
  ...
  Scenario: Forgejo references
    Given the origin is "git@codeberg.org:git-town/git-town.git"
    And Git setting "git-town.forge-type" is "forgejo"
    When I run "git-town sync --stack"
    Then Git Town runs the commands
      | BRANCH | COMMAND                                                                                |
      | child  | git fetch --prune --tags                                                               |
    ...
    And the proposals are now
      ...
      body:
        ...
        - main
          - **parent proposal** :point_left:
            - [child proposal](https://example.com/pr/2)
      ...
      body:
        ...
        -------------------------
        - main
          - [parent proposal](https://example.com/pr/1)
            - **child proposal** :point_left:
  ...
  Scenario: Gitea references
    Given the origin is "git@gitea.com:git-town/git-town.git"
    And Git setting "git-town.forge-type" is "gitea"
    When I run "git-town sync --stack"
    Then Git Town runs the commands
      | BRANCH | COMMAND                                                                                |
      | child  | git fetch --prune --tags                                                               |
  ...
  Scenario: GitLab references
    Given the origin is "git@gitlab.com:git-town/git-town.git"
