Feature: git kill: does not remove a given non-feature branch (without open changes)

  As a developer accidentally running "git kill" against a non-feature branch
