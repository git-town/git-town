Feature: git kill: Killing the current local feature branch (without open changes)

  As a developer having on a local dead-end feature branch
  ...
  Background:
    ...
    And I am on the local "dead-end-feature" branch
    When I run `git kill`
