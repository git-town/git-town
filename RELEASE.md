...
- create and push a new Git Tag for the release: `git tag v7.9.0`
- `env GITHUB_TOKEN=<your Github token> VERSION=7.9.0 make release-linux`
...
- `env VERSION=7.9.0 make msi` to create the Windows installer
- test the created Windows installer in the `dist` directory
- `env GITHUB_TOKEN=<your Github token> VERSION=7.9.0 make release-win`
