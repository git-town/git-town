...
// merges the given parent branch into the current branch, when encountering merge conflicts always keeps the
type MergeParentResolveToOurs struct {
...
func (self *MergeParentResolveToOurs) Run(args shared.RunArgs) error {
