...
func (self *ProposalUpdateLineage) Run(args shared.RunArgs) error {
	...
	for _, proposal := range proposals {
		...
		lineageSection := proposallineage.RenderSection(args.Config.Value.NormalConfig.Lineage, self.Branch, args.Config.Value.NormalConfig.Order, args.Config.Value.NormalConfig.ProposalsShowLineageSingleStack, args.Connector)
