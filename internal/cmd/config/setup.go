...
func enterForgeAuth(repo execute.OpenRepoResult, data *setupData) (aborted bool, tokenScope configdomain.ConfigScope, forgeTypeOpt Option[forgedomain.ForgeType], err error) {
