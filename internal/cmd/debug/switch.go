...
func switchBranch() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(_ *cobra.Command, args []string) error {
			...
			_, _, err = dialog.SwitchBranch(localBranches, []configdomain.BranchType{}, gitdomain.NewLocalBranchName("branch-2"), lineage, branchInfos, true, dialogTestInputs.Next())
			return err
		},
	}
}
