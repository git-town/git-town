...
func switchBranch() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(_ *cobra.Command, args []string) error {
			...
			_, _, err = dialog.SwitchBranch(localBranches, branchTypes, branchesAndTypes, gitdomain.NewLocalBranchName("branch-2"), lineage, branchInfos, configdomain.DefaultBranchType{BranchType: configdomain.BranchTypeFeatureBranch}, false, true, dialogTestInputs.Next())
			return err
		},
	}
}
