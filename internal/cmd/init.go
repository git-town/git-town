...
func executeConfigSetup(cliConfig configdomain.PartialConfig) error {
	...
	displayDialogs := envConfig.Interactivity.GetOr(systemConfig.Interactivity.GetOr(defaultConfig.Interactivity))
Start:
	...
	data.Config.NormalConfig.Interactivity = displayDialogs
