...
import (
	...
	"github.com/git-town/git-town/v24/internal/gohacks/cache"
	"github.com/git-town/git-town/v24/internal/gohacks/stringslice"
	"github.com/git-town/git-town/v24/internal/test/commands"
	"github.com/git-town/git-town/v24/internal/test/subshell"
...
func New(workingDir, homeDir, binDir string) commands.TestCommands {
	...
	unvalidatedConfig.UnvalidatedConfig.MainBranch = gitdomain.LocalBranchNameOpt("main")
	testCommands := commands.TestCommands{
		Git:    &gitCommands,
		Config: unvalidatedConfig,
		SnapShots: configdomain.BeginConfigSnapshot{
