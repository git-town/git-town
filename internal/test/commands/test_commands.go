...
func (self *TestCommands) CreateBranchUsingGitTown(name gitdomain.LocalBranchName, parent gitdomain.LocalBranchName, branchTypeOpt Option[configdomain.BranchType]) {
