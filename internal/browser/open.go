...
func Open(url string, frontend subshelldomain.Runner, config Option[forgedomain.Browser]) {
...
func OpenBrowserCommand(config Option[forgedomain.Browser]) Option[string] {
