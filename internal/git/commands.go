...
func (self *Commands) Commit(runner gitdomain.Runner, message Option[gitdomain.CommitMessage], missingCommitMessage MissingCommitMessage, author Option[gitdomain.Author]) error {
...
const (
	MissingCommitMessageAskUser    = true  // if the commit message is missing, let the user enter it
	MissingCommitMessageUseDefault = false // if the commit message is missing, use the default commit message
)
