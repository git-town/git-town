...
func DetectPhantomRebaseConflicts(fileConflicts MergeConflictInfos, parentBranch gitdomain.BranchName, rootBranch gitdomain.LocalBranchName) []PhantomConflict {
