...
func ParseBool[T ~bool](text stringss.TrimmedString, source string) (T, error) { //nolint:ireturn
...
func ParseBoolOpt[T ~bool](text stringss.TrimmedString, source string) (Option[T], error) {
	if text == "" {
		return None[T](), nil
	}
