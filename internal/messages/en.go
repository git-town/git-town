...
const (
	...
	BranchAlreadyExistsRemotely     = "there is already a branch %s at the \"origin\" remote"
	BranchAuthorMultiple            = "\nMultiple people authored the %s branch.\n\n"
	BranchCheckoutProblem           = "cannot check out branch %s: %s"
	BranchContainsMergeCommits      = "branch %s contains merge commits, please compress and try again"
	BranchCurrentProblem            = "cannot determine current branch: %s"
	...
	BranchDiffProblem               = "cannot determine if branch %s has unmerged commits: %s"
	...
	BranchLocalProblem              = "cannot determine whether the local branch %s exists: %s"
	BranchLocalSHAProblem           = "cannot determine SHA of local branch %s: %s"
	...
	CannotParse                        = "cannot parse %s: %s"
	CommandsRun                        = "Ran %s shell commands."
	CommitMessageProblem               = "cannot determine last commit message: %s"
	CommitsSelected                    = "%s commits selected"
	CompletionTypeUnknown              = "unknown completion type: %s"
	...
	ConfigFileCannotRead               = "cannot read the configuration file %s: %s"
	ConfigFileInvalidContent           = "the configuration file %s does not contain TOML-formatted content: %s"
	...
	ConfigRemoveError                  = "unexpected error while removing the 'git-town' section from the Git configuration: %s"
	ConfigScopeUnknown                 = "unknown configuration scope"
	ConfigShipStrategyUnknown          = "unknown ship strategy in %s: %s"
	ConfigStorage                      = "Config storage: %s\n"
	ConfigSyncStrategyUnknown          = "unknown sync strategy: %s"
	ConflictDetectionProblem           = "cannot determine conflicts: %s"
...
Please upgrade to the new format: create.new-branch-type = "prototype"`
	...
	DialogResultUnknownBranchType       = "unknown branch type defined in %s: %s"
	...
	DiffProblem                         = "cannot list diff of %s and %s: %s"
	...
	FileContentInvalidJSON       = "cannot parse JSON content of file %s: %s"
	FileDeleteProblem            = "cannot delete file %s: %s"
	FileReadProblem              = "cannot read file %s: %s"
	FileStatProblem              = "cannot check file %s: %s"
	FileWriteProblem             = "cannot write file %s: %s"
	Forge                        = "Forge: %s\n"
	...
	ForgeGiteaUpdatePRViaAPI     = "Gitea API: Updating base branch for PR #%s to #%s"
	ForgeGitHubMergingViaAPI     = "GitHub API: merging PR %s ... "
	ForgeGitLabMergingViaAPI     = "Merging MR !%s ... "
	ForgeGitLabUpdateMRViaAPI    = "Updating target branch for MR !%s to %s ... "
	...
	GitDirMissing                   = "cannot determine the '.git' directory: %s"
	GiteaTokenPrompt                = "Gitea token: "
	GiteaTokenResult                = "Gitea token: %s\n"
	GitHubConnectorTypeResult       = "GitHub connector: %s\n"
	GitHubConnectorTypeUnknown      = "unknown GitHubConnectorType defined in %s: %s"
	...
	GitLabConnectorTypeUnknown      = "unknown GitLabConnectorType defined in %s: %s"
	GitLabTokenPrompt               = "GitLab token: "
	GitLabTokenResult               = "GitLab token: %s\n"
	GitURLCannotParse               = "cannot parse Git URL %s"
	GitVersionMajorNotNumber        = "cannot convert major version %s to int: %s"
	GitVersionMinorNotNumber        = "cannot convert minor version %s to int: %s"
	GitVersionProblem               = "cannot determine Git version: %s"
	...
	InputAddOrRemove    = `invalid argument %s. Please provide either "add" or "remove"`
	InputYesOrNo        = `invalid argument: %s. Please provide either "yes" or "no".\n`
	InvalidStatusOutput = `invalid "git status -z" output: %s`
	...
	ObservedRegexCannotParse    = "unknown observed regex value (%s) defined in %s: %s"
	...
	OpcodeNotRunnable           = "unrunnable opcode: %s"
	OpcodeUnknown               = "unknown opcode: %s, run \"git town status reset\" to reset it"
	OpenChangesProblem          = "cannot determine open changes: %s"
	Order                       = "Order: %s\n"
	...
	ProposalMultipleFromFound               = "found %s proposals for branch %s"
	ProposalMultipleFromToFound             = "found %s proposals from branch %s to branch %s"
	...
	ProposalsLineageInvalid                 = "invalid value for whether proposals should show the lineage in %s: %s. Valid values are: none, ci, cli"
	ProposalSourceCannotUpdate              = "cannot update the proposal source branch on your forge"
	ProposalTargetBranchUpdateProblem       = "cannot update the target branch of proposal %s on your forge"
	ProposalURLProblem                      = "cannot determine proposal URL from %s to %s: %s"
...
Please upgrade to the new format: share-new-branches = "push"`
	...
	RebaseProblem           = "cannot determine rebase in progress: %s"
	RemoteExistsProblem     = "cannot determine if remote %s exists: %s"
	RemotesProblem          = "cannot determine remotes: %s"
...
and will be removed in future versions of Git Town.`
	...
	RunAutoUndo                    = "%s\nAuto-undo... "
	RunCommandProblem              = "error running command %s: %s"
	RunLogCannotOpen               = "cannot open runlog file %s: %s"
	RunLogCannotRead               = "cannot read runlog file %s: %s"
	RunLogCannotWrite              = "cannot write to runlog file %s: %s"
	RunLogDeleted                  = "Runlog deleted."
	RunlogDisplaying               = "Displaying runlog at %s\n"
	RunLogDoesntExist              = "Runlog doesn't exist."
	RunLogSerializeProblem         = "cannot encode runlog: %s"
	RunstateCannotDetermineUserDir = "cannot determine the user configuration directory: %s"
	RunstateDeleted                = "Runstate file deleted."
	RunstateDeleteProblem          = "cannot delete previous run state: %s"
	RunstateDoesntExist            = "Runstate file doesn't exist."
	RunstateLoadProblem            = "cannot load previous run state: %s"
	RunstateSaveProblem            = "cannot save run state: %s"
	RunstateSerializeProblem       = "cannot encode run-state: %s"
	...
	SquashCannotReadFile                  = "cannot read squash message file %s: %s"
	SquashCommitAuthorProblem             = "error getting squash commit author: %s"
	...
	SquashMessageProblem                  = "cannot comment out the squash commit message: %s"
	StashResult                           = "Stash: %s\n"
	...
	UndoCreateOpcodeProblem                 = "cannot create undo operations for %s: %s"
