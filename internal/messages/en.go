...
const (
	...
	CreatePrototypeBranchesDeprecation = `The Git Town configuration file contains the deprecated setting "create-prototype-branches". Please upgrade to the new format: "create.new-branch-type = "prototype"`
