...
Please upgrade to the new format: create.new-branch-type = "prototype"`
	...
	ProposalBreadcrumb                      = "Proposals display the stack lineage: %s\n"
	ProposalBreadcrumbInvalid               = "invalid value for whether proposals should show the lineage in %s: %q. Valid values are: none, ci, cli"
