...
Please upgrade to the new format: create.new-branch-type = "prototype"`
	...
	ProposalBreadcrumbInvalid               = "invalid value for proposal breadcrumb in %s: %q. Valid values are: none, cli"
	ProposalBreadcrumbSingle                = "Proposals display breadcrumb for single branches: %s\n"
