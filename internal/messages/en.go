...
Please upgrade to the new format: create.new-branch-type = "prototype"`
	...
	ProposalBreadcrumbInvalid               = "invalid value for proposal breadcrumb in %s: %q. Valid values are: none, ci, cli"
	ProposalBreadcrumbSingleStack           = "Proposals embed lineage for single stacks: %s\n"
