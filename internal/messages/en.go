...
and will be removed in future versions of Git Town.`
	...
	SyncStrategyOverrideNotSupportedForAll      = "sync doesn't support --all and --strategy flags at the same time"
	SyncStrategyOverrideNotSupportedForMultiple = "sync doesn't support --strategy override for multiple branches"
	SyncStrategyOverrideNotSupportedForStack    = "sync doesn't support --stack and --strategy flags at the same time"
