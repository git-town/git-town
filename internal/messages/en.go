...
Please upgrade to the new format: create.new-branch-type = "prototype"`
	...
	ObservedRegexCannotParse    = "unknown observed regex value (%s) defined in %s: %w"
...
and will be removed in future versions of Git Town.`
	...
	RunAutoUndo                    = "%s\nAuto-undo... "
	RunCommandProblem              = "error running command %s: %w"
	RunLogCannotOpen               = "cannot open runlog file %s: %w"
	RunLogCannotRead               = "cannot read runlog file %s: %w"
	RunLogCannotWrite              = "cannot write to runlog file %s: %w"
