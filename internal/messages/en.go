...
const (
	...
	ContributionRegexHelp             = `All branches whose name matches this regular expression
...
`
	...
	ObservedRegexHelp                = `All branches whose name matches this regular expression
