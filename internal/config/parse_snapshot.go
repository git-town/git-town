...
func NewPartialConfigFromSnapshot(snapshot configdomain.SingleSnapshot, updateOutdated bool, ignoreUnknown bool, runner subshelldomain.Runner) (configdomain.PartialConfig, error) {
	...
	proposalBreadcrumbExcludeBranches, errProposalBreadcrumbExcludeBranches := loadErr(snapshot, configdomain.KeyProposalBreadcrumbExcludeBranches, configdomain.ParseProposalBreadcrumbExcludeBranches, ignoreUnknown)
