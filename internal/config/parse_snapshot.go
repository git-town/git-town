...
func NewPartialConfigFromSnapshot(snapshot configdomain.SingleSnapshot, updateOutdated bool, ignoreUnknown bool, runner subshelldomain.Runner) (configdomain.PartialConfig, error) {
	...
	unknownBranch1, errUnknownBranchType := load(snapshot, configdomain.KeyUnknownBranchType, configdomain.ParseBranchType, ignoreUnknown)
	unknownBranch2 := configdomain.UnknownBranchTypeOpt(unknownBranchType1)
	// keep-sorted end
	err := cmp.Or(
		errAutoResolve,
		errAutoSync,
	...
	return configdomain.PartialConfig{
		...
		UnknownBranchType:           unknownBranch2,
