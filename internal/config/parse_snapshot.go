...
func NewPartialConfigFromSnapshot(snapshot configdomain.SingleSnapshot, updateOutdated bool, ignoreUnknown bool, runner subshelldomain.Runner) (configdomain.PartialConfig, error) {
	...
	proposalBreadcrumbDirection, errProposalBreadcrumbDirection := load(snapshot, configdomain.KeyProposalBreadcrumbDirection, forgedomain.ParseProposalBreadcrumbDirection, ignoreUnknown)
	proposalBreadcrumbStyle, errProposalBreadcrumbStyle := load(snapshot, configdomain.KeyProposalBreadcrumbStyle, forgedomain.ParseProposalBreadcrumbStyle, ignoreUnknown)
