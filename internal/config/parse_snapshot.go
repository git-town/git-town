...
func NewPartialConfigFromSnapshot(snapshot configdomain.SingleSnapshot, updateOutdated bool, ignoreUnknown bool, runner subshelldomain.Runner) (configdomain.PartialConfig, error) {
	...
	proposalBreadcrumbSingle, errProposalBreadcrumbSingle := load(snapshot, configdomain.KeyProposalBreadcrumbSingle, gohacks.ParseBoolOpt[forgedomain.ProposalBreadcrumbSingle], ignoreUnknown)
