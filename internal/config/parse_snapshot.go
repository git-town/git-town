...
func NewPartialConfigFromSnapshot(snapshot configdomain.SingleSnapshot, updateOutdated bool, ignoreUnknown bool, runner subshelldomain.Runner) (configdomain.PartialConfig, error) {
	...
	ignoreUncommitted, errIgnoreUncommitted := load(snapshot, configdomain.KeyIgnoreUncommitted, gohacks.Str2BoolOpt[configdomain.IgnoreUncommitted], ignoreUnknown)
	...
	offline, errOffline := load(snapshot, configdomain.KeyOffline, gohacks.Str2BoolOpt[configdomain.Offline], ignoreUnknown)
	...
	pushBranches, errPushBranches := load(snapshot, configdomain.KeyPushBranches, gohacks.Str2BoolOpt[configdomain.PushBranches], ignoreUnknown)
	pushHook, errPushHook := load(snapshot, configdomain.KeyPushHook, gohacks.Str2BoolOpt[configdomain.PushHook], ignoreUnknown)
	...
	shipDeleteTrackingBranch, errShipDeleteTrackingBranch := load(snapshot, configdomain.KeyShipDeleteTrackingBranch, gohacks.Str2BoolOpt[configdomain.ShipDeleteTrackingBranch], ignoreUnknown)
	shipStrategy, errShipStrategy := load(snapshot, configdomain.KeyShipStrategy, configdomain.ParseShipStrategy, ignoreUnknown)
	stash, errStash := load(snapshot, configdomain.KeyStash, gohacks.Str2BoolOpt[configdomain.Stash], ignoreUnknown)
	...
	syncTags, errSyncTags := load(snapshot, configdomain.KeySyncTags, gohacks.Str2BoolOpt[configdomain.SyncTags], ignoreUnknown)
	syncUpstream, errSyncUpstream := load(snapshot, configdomain.KeySyncUpstream, gohacks.Str2BoolOpt[configdomain.SyncUpstream], ignoreUnknown)
