...
func NewPartialConfigFromSnapshot(snapshot configdomain.SingleSnapshot, updateOutdated bool, runner subshelldomain.Runner) (configdomain.PartialConfig, error) {
	...
	offline, errOffline := loadField(snapshot, configdomain.KeyOffline, gohacks.ParseBoolOpt[configdomain.Offline])
	perennialRegex, errPerennialRegex := loadField(snapshot, configdomain.KeyPerennialRegex, configdomain.ParsePerennialRegex)
	proposalsShowLineage, errProposalsShowLineage := loadField(snapshot, configdomain.KeyProposalsShowLineage, forgedomain.ParseProposalsShowLineage)
	pushBranches, errPushBranches := loadField(snapshot, configdomain.KeyPushBranches, gohacks.ParseBoolOpt[configdomain.PushBranches])
	pushHook, errPushHook := loadField(snapshot, configdomain.KeyPushHook, gohacks.ParseBoolOpt[configdomain.PushHook])
	shareNewBranches, errShareNewBranches := loadField(snapshot, configdomain.KeyShareNewBranches, configdomain.ParseShareNewBranches)
	shipDeleteTrackingBranch, errShipDeleteTrackingBranch := loadField(snapshot, configdomain.KeyShipDeleteTrackingBranch, gohacks.ParseBoolOpt[configdomain.ShipDeleteTrackingBranch])
