...
func Load(env EnvVars) (configdomain.PartialConfig, error) {
	...
	browser, errBrowser := load(env, Browser, forgedomain.ParseBrowser)
	...
	proposeHeadless, errProposeHeadless := load(env, proposeHeadless, gohacks.ParseBoolOpt[forgedomain.ProposeHeadless])
