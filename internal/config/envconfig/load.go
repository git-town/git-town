...
func Load(env EnvVars) (configdomain.PartialConfig, error) {
	...
	gitUserEmail := NewStrTypeOption[gitdomain.GitUserEmail](env.GetFirstNonEmpty(gitAuthorEmail, gitCommitterEmail))
	gitUserName := NewStrTypeOption[gitdomain.GitUserName](env.GetFirstNonEmpty(gitAuthorName, gitCommitterName))
