...
func Load(env EnvVars) (configdomain.PartialConfig, error) {
	...
	gitUserEmail := NewOptionStrType[gitdomain.GitUserEmail](env.GetFirstNonEmpty(gitAuthorEmail, gitCommitterEmail))
	gitUserName := NewOptionStrType[gitdomain.GitUserName](env.GetFirstNonEmpty(gitAuthorName, gitCommitterName))
