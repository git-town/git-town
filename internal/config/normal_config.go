...
type NormalConfig struct {
	...
	ProposalBreadcrumbSingle forgedomain.ProposalBreadcrumbSingle
...
func (self *NormalConfig) OverwriteWith(other configdomain.PartialConfig) NormalConfig {
	return NormalConfig{
		...
		ProposalBreadcrumbSingle: other.ProposalBreadcrumbSingle.GetOr(self.ProposalBreadcrumbSingle),
...
func DefaultNormalConfig() NormalConfig {
	return NormalConfig{
		...
		ProposalBreadcrumbSingle: false,
		PushBranches:             true,
		PushHook:                 true,
...
func NewNormalConfigFromPartial(partial configdomain.PartialConfig, defaults NormalConfig) NormalConfig {
	...
	return NormalConfig{
		...
		ProposalBreadcrumbSingle: partial.ProposalBreadcrumbSingle.GetOr(defaults.ProposalBreadcrumbSingle),
