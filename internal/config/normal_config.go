...
func (self *NormalConfig) OverwriteWith(other configdomain.PartialConfig) NormalConfig {
	return NormalConfig{
		...
		ProposalBreadcrumbExcludeBranches: other.ProposalBreadcrumbExcludeBranches.GetOr(self.ProposalBreadcrumbExcludeBranches),
...
func NewNormalConfigFromPartial(partial configdomain.PartialConfig, defaults NormalConfig) NormalConfig {
	...
	return NormalConfig{
		...
		ProposalBreadcrumbExcludeBranches: partial.ProposalBreadcrumbExcludeBranches.GetOr(defaults.ProposalBreadcrumbExcludeBranches),
