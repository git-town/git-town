...
func TestLineage(t *testing.T) {
	...
	one := gitdomain.LocalBranchName("one")
	two := gitdomain.LocalBranchName("two")
	three := gitdomain.LocalBranchName("three")
	alpha := gitdomain.LocalBranchName("alpha")
	beta := gitdomain.LocalBranchName("beta")
	...
	t.Run("Ancestor", func(t *testing.T) {
		...
		t.Run("3rd ancestor returns the great-grandparent", func(t *testing.T) {
			t.Parallel()
			four := gitdomain.LocalBranchName("four")
			lineage := configdomain.NewLineageWith(configdomain.LineageData{
				four:  three,
				three: two,
				two:   one,
	...
	t.Run("BranchesAndAncestors", func(t *testing.T) {
		...
		t.Run("multiple lineages", func(t *testing.T) {
			t.Parallel()
			first := gitdomain.LocalBranchName("first")
			second := gitdomain.LocalBranchName("second")
			third := gitdomain.LocalBranchName("third")
			lineage := configdomain.NewLineageWith(configdomain.LineageData{
				one:    main,
				two:    one,
				three:  two,
	...
	t.Run("Children", func(t *testing.T) {
		...
		t.Run("provides all children of the given branch, ordered ascending", func(t *testing.T) {
			t.Parallel()
			twoA := gitdomain.LocalBranchName("twoA")
			twoB := gitdomain.LocalBranchName("twoB")
			lineage := configdomain.NewLineageWith(configdomain.LineageData{
				twoA: one,
				twoB: one,
			})
	...
	t.Run("Descendants", func(t *testing.T) {
		...
		t.Run("branch has no children", func(t *testing.T) {
			...
			other := gitdomain.LocalBranchName("other")
			lineage := configdomain.NewLineageWith(configdomain.LineageData{
				branch: main,
				other:  main,
			})
		...
		t.Run("branch has only direct children", func(t *testing.T) {
			t.Parallel()
			branch := gitdomain.LocalBranchName("branch")
			child1 := gitdomain.LocalBranchName("child1")
			child2 := gitdomain.LocalBranchName("child2")
			other := gitdomain.LocalBranchName("other")
			lineage := configdomain.NewLineageWith(configdomain.LineageData{
				branch: main,
				child1: branch,
		...
		t.Run("branch has grandchildren", func(t *testing.T) {
			...
			branch := gitdomain.LocalBranchName("branch")
			child1 := gitdomain.LocalBranchName("child1")
			child1a := gitdomain.LocalBranchName("child1a")
			child1b := gitdomain.LocalBranchName("child1b")
			child2 := gitdomain.LocalBranchName("child2")
			child2a := gitdomain.LocalBranchName("child2a")
			child2b := gitdomain.LocalBranchName("child2b")
			other := gitdomain.LocalBranchName("other")
			lineage := configdomain.NewLineageWith(configdomain.LineageData{
				branch:  main,
				child1:  branch,
	...
	t.Run("Entries", func(t *testing.T) {
		...
		t.Run("populated", func(t *testing.T) {
			...
			branch3 := gitdomain.LocalBranchName("branch-3")
			branch4 := gitdomain.LocalBranchName("branch-4")
			lineage := configdomain.NewLineageWith(configdomain.LineageData{
				branch1: branch2,
				branch3: branch4,
			})
	...
	t.Run("RemoveBranch", func(t *testing.T) {
		...
		t.Run("branch is a parent branch", func(t *testing.T) {
			...
			main := gitdomain.LocalBranchName("main")
			branch1 := gitdomain.LocalBranchName("branch-1")
			branch1a := gitdomain.LocalBranchName("branch-1a")
			branch1b := gitdomain.LocalBranchName("branch-1b")
			branch2 := gitdomain.LocalBranchName("branch-2")
	...
	t.Run("Roots", func(t *testing.T) {
		...
		t.Run("multiple roots with child branches", func(t *testing.T) {
			t.Parallel()
			prod := gitdomain.LocalBranchName("prod")
			hotfix1 := gitdomain.LocalBranchName("hotfix1")
			hotfix2 := gitdomain.LocalBranchName("hotfix2")
			lineage := configdomain.NewLineageWith(configdomain.LineageData{
				two:     one,
				one:     main,
				hotfix1: prod,
	...
	t.Run("Set", func(t *testing.T) {
		...
		t.Run("empty", func(t *testing.T) {
			t.Parallel()
			branch := gitdomain.LocalBranchName("branch")
			parent := gitdomain.LocalBranchName("parent")
			lineage := configdomain.NewLineage()
