...
type PartialConfig struct {
	...
	ProposalsBreadcrumbSingle Option[forgedomain.ProposalBreadcrumbSingle]
...
func (self PartialConfig) Merge(other PartialConfig) PartialConfig {
	return PartialConfig{
		...
		ProposalsBreadcrumbSingle: other.ProposalsBreadcrumbSingle.Or(self.ProposalsBreadcrumbSingle),
