		...
		after := gitdomain.BranchesSnapshot{
			Branches: gitdomain.BranchInfos{
				...
				gitdomain.BranchInfo{
					...
					RemoteSHA:  Some(gitdomain.SHAFromString("222222")),
				},
			},
			Active: gitdomain.LocalBranchNameOpt("feature-branch"),
		}
		...
		after := gitdomain.BranchesSnapshot{
			Branches: gitdomain.BranchInfos{
				gitdomain.BranchInfo{
					...
					SyncStatus: gitdomain.SyncStatusUpToDate,
					RemoteName: Some(gitdomain.RemoteBranchNameOrPanic("origin/perennial-branch")),
					RemoteSHA:  Some(gitdomain.SHAFromString("444444")),
				},
				gitdomain.BranchInfo{
					Local:      Some(gitdomain.BranchData{Name: "feature-branch", SHA: "555555"}),
					SyncStatus: gitdomain.SyncStatusUpToDate,
					RemoteName: Some(gitdomain.RemoteBranchNameOrPanic("origin/feature-branch")),
					RemoteSHA:  Some(gitdomain.SHAFromString("666666")),
				},
			},
			Active: gitdomain.LocalBranchNameOpt("feature-branch"),
		}
		...
		before := gitdomain.BranchesSnapshot{
			Branches: gitdomain.BranchInfos{
				gitdomain.BranchInfo{
					...
					SyncStatus: gitdomain.SyncStatusUpToDate,
					RemoteName: Some(gitdomain.RemoteBranchNameOrPanic("origin/main")),
					RemoteSHA:  Some(gitdomain.SHAFromString("111111")),
				},
				gitdomain.BranchInfo{
				...
				gitdomain.BranchInfo{
					...
					SyncStatus: gitdomain.SyncStatusUpToDate,
					RemoteName: Some(gitdomain.RemoteBranchNameOrPanic("origin/feature-branch")),
					RemoteSHA:  Some(gitdomain.SHAFromString("333333")),
				},
			},
			Active: gitdomain.LocalBranchNameOpt("feature-branch"),
		}
		after := gitdomain.BranchesSnapshot{
			Branches: gitdomain.BranchInfos{
				...
				gitdomain.BranchInfo{
					...
					SyncStatus: gitdomain.SyncStatusUpToDate,
					RemoteName: Some(gitdomain.RemoteBranchNameOrPanic("origin/perennial-branch")),
					RemoteSHA:  Some(gitdomain.SHAFromString("555555")),
				},
				gitdomain.BranchInfo{
		...
		before := gitdomain.BranchesSnapshot{
			Branches: gitdomain.BranchInfos{
				gitdomain.BranchInfo{
					...
					SyncStatus: gitdomain.SyncStatusUpToDate,
					RemoteName: Some(gitdomain.RemoteBranchNameOrPanic("origin/old")),
					RemoteSHA:  Some(gitdomain.SHAFromString("111111")),
				},
			},
		...
		after := gitdomain.BranchesSnapshot{
			Branches: gitdomain.BranchInfos{
				...
				gitdomain.BranchInfo{
					Local:      None[gitdomain.BranchData](),
					SyncStatus: gitdomain.SyncStatusRemoteOnly,
					RemoteName: Some(gitdomain.RemoteBranchNameOrPanic("upstream/main")),
					RemoteSHA:  Some(gitdomain.SHAFromString("222222")),
				},
			},
			Active: gitdomain.LocalBranchNameOpt("feature-branch"),
