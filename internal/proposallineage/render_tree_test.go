...
func TestTreeNodesWithProposal(t *testing.T) {
	t.Parallel()
...
`
		have := proposallineage.TreeNodesWithProposal{tree}.Render("feature-1A", configdomain.ProposalBreadcrumbDirectionDown, None[forgedomain.Connector]())
...
<sup>[Stack](https://www.git-town.com/how-to/proposal-breadcrumb.html) generated by [Git Town](https://github.com/git-town/git-town)</sup>
`
		have := proposallineage.TreeNodesWithProposal{tree}.Render("feature-1", configdomain.ProposalBreadcrumbDirectionDown, None[forgedomain.Connector]())
		must.EqOp(t, want, have)
	})
...
<sup>[Stack](https://www.git-town.com/how-to/proposal-breadcrumb.html) generated by [Git Town](https://github.com/git-town/git-town)</sup>
`
		have := proposallineage.TreeNodesWithProposal{tree}.Render("feature-1A", configdomain.ProposalBreadcrumbDirectionUp, None[forgedomain.Connector]())
		must.EqOp(t, want, have)
	})
...
<sup>[Stack](https://www.git-town.com/how-to/proposal-breadcrumb.html) generated by [Git Town](https://github.com/git-town/git-town)</sup>
`
		have := proposallineage.TreeNodesWithProposal{tree}.Render("feature-2", configdomain.ProposalBreadcrumbDirectionDown, None[forgedomain.Connector]())
		must.EqOp(t, want, have)
	})
}
