...
func parseMergeRequest(mergeRequest *gitlab.BasicMergeRequest) forgedomain.ProposalData {
	return forgedomain.ProposalData{
		...
		Source:       gitdomain.LocalBranchNameOrPanic(stringss.Trim(mergeRequest.SourceBranch)),
		Target:       gitdomain.LocalBranchNameOrPanic(stringss.Trim(mergeRequest.TargetBranch)),
