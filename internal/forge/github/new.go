...
func parsePullRequest(pullRequest *github.PullRequest) forgedomain.ProposalData {
	return forgedomain.ProposalData{
		...
		Source:       gitdomain.LocalBranchNameOrPanic(stringss.Trim(pullRequest.Head.GetRef())),
		Target:       gitdomain.LocalBranchNameOrPanic(stringss.Trim(pullRequest.Base.GetRef())),
