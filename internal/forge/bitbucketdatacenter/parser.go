...
func parsePullRequest(pullRequest PullRequest, repoURL string) forgedomain.ProposalData {
	return forgedomain.ProposalData{
		...
		Source:       gitdomain.LocalBranchNameOrPanic(stringss.Trim(pullRequest.FromRef.DisplayID)),
		Target:       gitdomain.LocalBranchNameOrPanic(stringss.Trim(pullRequest.ToRef.DisplayID)),
