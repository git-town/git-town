...
type RunState struct {
	...
	AbortProgram          program.Program                        // opcodes to abort the currently pending Git operation
	...
	//exhaustruct:optional
	FinalUndoProgram program.Program       // additional opcodes to run after this RunState was undone
	...
	//exhaustruct:optional
	UndoablePerennialCommits []gitdomain.SHA // contains the SHAs of commits on perennial branches that can safely be undone
	//exhaustruct:optional
	UnfinishedDetails OptionalMutable[UnfinishedRunStateDetails]
}
