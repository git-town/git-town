	...
	t.Run("Save and Load", func(t *testing.T) {
		...
		runState := runstate.RunState{
			...
			RunProgram: program.Program{
				...
				&opcodes.CheckoutHistoryPreserve{PreviousBranchCandidates: []Option[gitdomain.LocalBranchName]{gitdomain.LocalBranchNameOpt("previous")}},
				...
				&opcodes.ConflictMergePhantomResolveAll{CurrentBranch: "current", ParentBranch: gitdomain.LocalBranchNameOpt("parent"), ParentSHA: Some(gitdomain.SHAFromString("123456"))},
				...
				&opcodes.MergeParentResolvePhantomConflicts{CurrentBranch: "current", CurrentParent: "parent", InitialParentName: gitdomain.LocalBranchNameOpt("original-parent"), InitialParentSHA: Some(gitdomain.SHAFromString("123456"))},
				...
				&opcodes.SyncFeatureBranchCompress{CommitMessage: Some(gitdomain.CommitMessage("commit message")), CurrentBranch: "branch", Offline: true, InitialParentName: gitdomain.LocalBranchNameOpt("parent"), InitialParentSHA: Some(gitdomain.SHAFromString("111111")), TrackingBranch: Some(gitdomain.RemoteBranchNameOrPanic("origin/branch")), PushBranches: true},
				&opcodes.SyncFeatureBranchMerge{Branch: "branch", InitialParentName: gitdomain.LocalBranchNameOpt("original-parent"), InitialParentSHA: Some(gitdomain.SHAFromString("123456")), TrackingBranch: Some(gitdomain.RemoteBranchNameOrPanic("origin/branch"))},
				&opcodes.SyncFeatureBranchRebase{Branch: "branch", ParentSHAPreviousRun: Some(gitdomain.SHAFromString("111111")), PushBranches: true, TrackingBranch: Some(gitdomain.RemoteBranchNameOrPanic("origin/branch"))},
			},
