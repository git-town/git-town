...
func EnterAll(inputs dialogcomponents.Inputs, interactive configdomain.Interactive) (bool, dialogdomain.Exit, error) {
	...
	selection, exit, err := dialogcomponents.RadioList(entries, 0, enterAllTitle, enterAllHelp, inputs, interactive, "enter-all")
