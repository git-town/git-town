...
func CheckList[S any](entries list.Entries[S], selections []int, title, help string, inputs Inputs, displayDialogs configdomain.Interactivity, dialogName string) ([]S, dialogdomain.Exit, error) {
