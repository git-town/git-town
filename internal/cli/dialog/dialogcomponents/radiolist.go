...
func RadioList[S any](entries list.Entries[S], cursor int, title, help string, inputs Inputs, displayDialogs configdomain.Interactivity, dialogName string) (S, dialogdomain.Exit, error) { //nolint:ireturn
