...
func GithubConnectorType(args Args[forgedomain.GithubConnectorType]) (Option[forgedomain.GithubConnectorType], dialogdomain.Exit, error) {
	...
	selection, exit, err := dialogcomponents.RadioList(entries, cursor, githubConnectorTypeTitle, githubConnectorTypeHelp, args.Inputs, args.Interactive, "github-connector")
