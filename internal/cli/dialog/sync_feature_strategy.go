...
func SyncFeatureStrategy(args Args[configdomain.SyncFeatureStrategy]) (Option[configdomain.SyncFeatureStrategy], dialogdomain.Exit, error) {
	...
	selection, exit, err := dialogcomponents.RadioList(entries, defaultPos, syncFeatureStrategyTitle, SyncFeatureStrategyHelp, args.Inputs, args.Interactive, "sync-feature-strategy")
