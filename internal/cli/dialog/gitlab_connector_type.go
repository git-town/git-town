...
func GitlabConnectorType(args Args[forgedomain.GitlabConnectorType]) (Option[forgedomain.GitlabConnectorType], dialogdomain.Exit, error) {
	...
	selection, exit, err := dialogcomponents.RadioList(entries, cursor, gitlabConnectorTypeTitle, gitlabConnectorTypeHelp, args.Inputs, args.Interactive, "gitlab-connector")
