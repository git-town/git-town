...
func IgnoreUncommitted(args Args[configdomain.IgnoreUncommitted]) (Option[configdomain.IgnoreUncommitted], dialogdomain.Exit, error) {
	...
	selection, exit, err := dialogcomponents.RadioList(entries, defaultPos, ignoreUncommittedTitle, IgnoreUncommittedHelp, args.Inputs, args.Interactive, "ignore-uncommitted")
