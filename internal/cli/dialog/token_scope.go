...
func TokenScope(oldValue configdomain.ConfigScope, inputs dialogcomponents.Inputs, interactivity configdomain.Interactivity) (configdomain.ConfigScope, dialogdomain.Exit, error) {
	...
	selection, exit, err := dialogcomponents.RadioList(entries, defaultPos, tokenScopeTitle, tokenScopeHelp, inputs, interactivity, "token-scope")
