...
func TokenScope(oldValue configdomain.ConfigScope, inputs dialogcomponents.Inputs, displayDialogs configdomain.Interactivity) (configdomain.ConfigScope, dialogdomain.Exit, error) {
