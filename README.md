...
* [git town alias](/documentation/commands/alias.md) - adds or removes default global aliases
* [git town config](/documentation/commands/config.md) - displays or updates your Git Town configuration
* [git town hack-push-flag](/documentation/commands/hack-push-flag.md) - configures whether new branches are pushed to origin
...
* [git town pull-branch-strategy](/documentation/commands/pull-branch-strategy.md) - displays or sets the strategy with which perennial branches are updated (rebase or merge)
