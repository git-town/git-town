...
[download the Windows installer](https://github.com/git-town/git-town/releases/download/v11.0.0/git-town_11.0.0_windows_intel_64.msi)
and run it.
...
```
sudo apt-get install git-town_11.0.0_linux_intel_64.deb
```
...
```
rpm -i git-town_11.0.0_linux_intel_64.rpm
```
