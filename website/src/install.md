...
[download the Windows installer](https://github.com/git-town/git-town/releases/download/v10.0.0/git-town_10.0.0_windows_intel_64.msi)
...
```
sudo apt-get install git-town_10.0.0_linux_intel_64.deb
```
...
```
rpm -i git-town_10.0.0_linux_intel_64.rpm
```
