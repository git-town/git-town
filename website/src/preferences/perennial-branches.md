...
You populate this setting with a list of branch names.

If you have many perennial branches that follow the same naming schema,
like `release-v4.0-rev.1`, `release-v4.0-rev.2`, etc,
