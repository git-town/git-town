...
installation is properly configured, "git town sync --all" guarantees that it never
...
"git town sync" needs to prove that the branch to be deleted contains no unshipped
