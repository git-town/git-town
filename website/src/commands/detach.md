...
This is most useful when a branch in a stack makes changes that don't overlap
with the changes made by other branches in this stack. Detaching such
independent branches reduces your stack to branches that belong together, and
