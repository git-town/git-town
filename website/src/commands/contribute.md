...
it makes the current branch a contribution branch.

To convert a contribution branch back into a feature branch,
...
this commands makes the branches with the given names contribution branches.
...
on your local machine) and make it a contribution branch:
