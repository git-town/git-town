...
```command-summary
git town repo [<remote-name>] [--browser <executable> | --no-browser] [-h | --help] [-v | --verbose]
```

The _repo_ command ("show me the repository") opens the homepage of the current
repository in your browser.
Git Town can display repositories hosted on [GitHub](https://github.com),
...
it shows the repository at the remote with the given name.
...
development remote.
You can override the type of hosting server with the
