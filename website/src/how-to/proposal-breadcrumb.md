...
These branch stacks are kept up to date automatically when you:
...
There are two ways to maintain branch stacks. You only need to enable one of
them.
...
- [proposals-show-lineage](../preferences/proposals-show-lineage.md) toggles
  whether Git Town shows branch lineage in proposals
