...
Git Town solves the pain that using Git correctly is so cumbersome and
repetitive that almost nobody uses Git correctly. Git Town provides additional
Git commands that make creating, synchronizing, shipping, and cleanup of Git
branches efficient. Supports mono-repos and stacked changes.
